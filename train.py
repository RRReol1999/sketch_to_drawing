...
parser.add_argument('--style_dir', default='./drive/MyDrive/StyTR-2-main/input/sty', type=str,  #wikiart dataset crawled from https://www.wikiart.org/
                    help='Directory path to a batch of style images')
parser.add_argument('--vgg', type=str, default='./drive/MyDrive/StyTR-2-main/experiments/vgg_normalised.pth')  #run the train.py, please download the pretrained vgg checkpoint
